    ...
    pub fn config(&self, index: u32) -> Result<Option<ConfigParamEnum>> {
        ...
        if let Some(slice) = self.config_params.get(key)? {
            if let Some(cell) = slice.reference_opt(0) {
                return Ok(Some(ConfigParamEnum::construct_from_slice_and_number(
                    &mut SliceData::load_cell(cell)?,
                    index,
                )?));
            }
        }
...
impl ConfigParamEnum {
    ...
    pub fn construct_from_slice_and_number(
        slice: &mut SliceData,
        index: u32,
    ) -> Result<ConfigParamEnum> {
        match index {
            0 => {
                read_config!(ConfigParam0, ConfigParam0, slice)
            }
            1 => {
                read_config!(ConfigParam1, ConfigParam1, slice)
            }
            2 => {
                read_config!(ConfigParam2, ConfigParam2, slice)
            }
            3 => {
                read_config!(ConfigParam3, ConfigParam3, slice)
            }
            4 => {
                read_config!(ConfigParam4, ConfigParam4, slice)
            }
            5 => {
                read_config!(ConfigParam5, ConfigParam5, slice)
            }
            6 => {
                read_config!(ConfigParam6, ConfigParam6, slice)
            }
            7 => {
                read_config!(ConfigParam7, ConfigParam7, slice)
            }
            8 => {
                read_config!(ConfigParam8, ConfigParam8, slice)
            }
            9 => {
                read_config!(ConfigParam9, ConfigParam9, slice)
            }
            10 => {
                read_config!(ConfigParam10, ConfigParam10, slice)
            }
            11 => {
                read_config!(ConfigParam11, ConfigParam11, slice)
            }
            12 => {
                read_config!(ConfigParam12, ConfigParam12, slice)
            }
            13 => {
                read_config!(ConfigParam13, ConfigParam13, slice)
            }
            14 => {
                read_config!(ConfigParam14, ConfigParam14, slice)
            }
            15 => {
                read_config!(ConfigParam15, ConfigParam15, slice)
            }
            16 => {
                read_config!(ConfigParam16, ConfigParam16, slice)
            }
            17 => {
                read_config!(ConfigParam17, ConfigParam17, slice)
            }
            18 => {
                read_config!(ConfigParam18, ConfigParam18, slice)
            }
            20 => {
                read_config!(ConfigParam20, GasLimitsPrices, slice)
            }
            21 => {
                read_config!(ConfigParam21, GasLimitsPrices, slice)
            }
            22 => {
                read_config!(ConfigParam22, ConfigParam22, slice)
            }
            23 => {
                read_config!(ConfigParam23, ConfigParam23, slice)
            }
            24 => {
                read_config!(ConfigParam24, MsgForwardPrices, slice)
            }
            25 => {
                read_config!(ConfigParam25, MsgForwardPrices, slice)
            }
            28 => {
                read_config!(ConfigParam28, CatchainConfig, slice)
            }
            29 => {
                read_config!(ConfigParam29, ConfigParam29, slice)
            }
            30 => {
                read_config!(ConfigParam30, DelectorParams, slice)
            }
            31 => {
                read_config!(ConfigParam31, ConfigParam31, slice)
            }
            32 => {
                read_config!(ConfigParam32, ConfigParam32, slice)
            }
            33 => {
                read_config!(ConfigParam33, ConfigParam33, slice)
            }
            34 => {
                read_config!(ConfigParam34, ConfigParam34, slice)
            }
            35 => {
                read_config!(ConfigParam35, ConfigParam35, slice)
            }
            36 => {
                read_config!(ConfigParam36, ConfigParam36, slice)
            }
            37 => {
                read_config!(ConfigParam37, ConfigParam37, slice)
            }
            39 => {
                read_config!(ConfigParam39, ConfigParam39, slice)
            }
            40 => {
                read_config!(ConfigParam40, ConfigParam40, slice)
            }
            42 => {
                read_config!(ConfigParam42, ConfigCopyleft, slice)
            }
            44 => {
...
impl GasLimitsPrices {
    ...
    pub fn calc_max_gas_threshold(&self) -> u128 {
        ...
        if self.gas_limit > self.flat_gas_limit {
            result +=
                ((self.gas_price as u128) * ((self.gas_limit - self.flat_gas_limit) as u128)) >> 16;
        }
        result
    }
}
...
pub(crate) fn dump_config(params: &HashmapE) {
    params
        .iterate_slices(|ref mut key, ref mut slice| -> Result<bool> {
            ...
            match ConfigParamEnum::construct_from_slice_and_number(
                &mut SliceData::load_cell(slice.reference(0)?)?,
                key,
            )? {
